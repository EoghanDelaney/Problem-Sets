...
# Using the above website it was straightforward to manipulate the string to the desired format. 
...
# List of all the date endings that is not "th" this was modified from the above stackoverflow page 
endings = {    
    1: 'st',
    2: 'nd',
    3: 'rd',
